  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="entityDemoApp.userUpload.home.createOrEditLabel" data-cy="UserUploadCreateUpdateHeading">
            <Translate contentKey="entityDemoApp.userUpload.home.createOrEditLabel">Create or edit a UserUpload</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('entityDemoApp.userUpload.dateUploaded')}
              ...
              <ValidatedField
                ...
                name="appUser"
                data-cy="appUser"
                label={translate('entityDemoApp.userUpload.appUser')}
                type="select"
              >
                <option value="" key="0" />
                {appUsers
