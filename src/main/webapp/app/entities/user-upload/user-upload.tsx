  ...
  return (
    <div>
      <h2 id="user-upload-heading" data-cy="UserUploadHeading">
        <Translate contentKey="entityDemoApp.userUpload.home.title">User Uploads</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="entityDemoApp.userUpload.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="entityDemoApp.userUpload.home.createLabel">Create new User Upload</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userUploadList && userUploadList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="entityDemoApp.userUpload.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="entityDemoApp.userUpload.dateUploaded">Date Uploaded</Translate>
                </th>
                <th>
                  <Translate contentKey="entityDemoApp.userUpload.appUser">App User</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="entityDemoApp.userUpload.home.notFound">No User Uploads found</Translate>
            </div>
          )
        )}
      </div>
