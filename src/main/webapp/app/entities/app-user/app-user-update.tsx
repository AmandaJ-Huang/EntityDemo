  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="entityDemoApp.appUser.home.createOrEditLabel" data-cy="AppUserCreateUpdateHeading">
            <Translate contentKey="entityDemoApp.appUser.home.createOrEditLabel">Create or edit a AppUser</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                label={translate('entityDemoApp.appUser.internalUser')}
                type="select"
              >
                <option value="" key="0" />
                {users
