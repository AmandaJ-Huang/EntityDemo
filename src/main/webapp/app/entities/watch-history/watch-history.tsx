  ...
  return (
    <div>
      <h2 id="watch-history-heading" data-cy="WatchHistoryHeading">
        <Translate contentKey="entityDemoApp.watchHistory.home.title">Watch Histories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="entityDemoApp.watchHistory.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="entityDemoApp.watchHistory.home.createLabel">Create new Watch History</Translate>
          </Link>
        </div>
      </h2>
        ...
        {watchHistoryList && watchHistoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="entityDemoApp.watchHistory.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="entityDemoApp.watchHistory.dateWatched">Date Watched</Translate>
                </th>
                <th>
                  <Translate contentKey="entityDemoApp.watchHistory.appUser">App User</Translate>
                </th>
                <th>
                  <Translate contentKey="entityDemoApp.watchHistory.video">Video</Translate>
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`${match.url}/${watchHistory.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="entityDemoApp.watchHistory.home.notFound">No Watch Histories found</Translate>
            </div>
          )
        )}
      </div>
