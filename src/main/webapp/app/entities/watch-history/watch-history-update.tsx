  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          appUser: watchHistoryEntity?.appUser?.id,
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="entityDemoApp.watchHistory.home.createOrEditLabel" data-cy="WatchHistoryCreateUpdateHeading">
            <Translate contentKey="entityDemoApp.watchHistory.home.createOrEditLabel">Create or edit a WatchHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('entityDemoApp.watchHistory.dateWatched')}
              ...
              />
              <ValidatedField
                id="watch-history-appUser"
                name="appUser"
                data-cy="appUser"
                label={translate('entityDemoApp.watchHistory.appUser')}
                type="select"
              >
                <option value="" key="0" />
                {appUsers
              ...
              <ValidatedField
                label={translate('entityDemoApp.watchHistory.video')}
