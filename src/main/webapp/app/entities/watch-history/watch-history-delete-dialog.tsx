...
export const WatchHistoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="entityDemoApp.watchHistory.delete.question">
        <Translate contentKey="entityDemoApp.watchHistory.delete.question" interpolate={{ id: watchHistoryEntity.id }}>
