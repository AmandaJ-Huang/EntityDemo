...
export const UserCommentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="entityDemoApp.userComment.delete.question">
        <Translate contentKey="entityDemoApp.userComment.delete.question" interpolate={{ id: userCommentEntity.id }}>
