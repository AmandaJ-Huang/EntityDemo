  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="entityDemoApp.genre.home.createOrEditLabel" data-cy="GenreCreateUpdateHeading">
            <Translate contentKey="entityDemoApp.genre.home.createOrEditLabel">Create or edit a Genre</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('entityDemoApp.genre.apiId')} id="genre-apiId" name="apiId" data-cy="apiId" type="text" />
              <ValidatedField label={translate('entityDemoApp.genre.name')} id="genre-name" name="name" data-cy="name" type="text" />
