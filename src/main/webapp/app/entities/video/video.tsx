  ...
  return (
    <div>
      <h2 id="video-heading" data-cy="VideoHeading">
        <Translate contentKey="entityDemoApp.video.home.title">Videos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="entityDemoApp.video.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="entityDemoApp.video.home.createLabel">Create new Video</Translate>
          </Link>
        </div>
      </h2>
        ...
        {videoList && videoList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="entityDemoApp.video.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="entityDemoApp.video.home.notFound">No Videos found</Translate>
            </div>
          )
        )}
      </div>
