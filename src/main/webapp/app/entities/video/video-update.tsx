  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="entityDemoApp.video.home.createOrEditLabel" data-cy="VideoCreateUpdateHeading">
            <Translate contentKey="entityDemoApp.video.home.createOrEditLabel">Create or edit a Video</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('entityDemoApp.video.title')} id="video-title" name="title" data-cy="title" type="text" />
              <ValidatedField
                label={translate('entityDemoApp.video.imageUrl')}
                id="video-imageUrl"
                name="imageUrl"
                data-cy="imageUrl"
                type="text"
              />
              <ValidatedField
                label={translate('entityDemoApp.video.videoUrl')}
                id="video-videoUrl"
                name="videoUrl"
                data-cy="videoUrl"
                type="text"
              />
              <ValidatedField
                label={translate('entityDemoApp.video.trailerId')}
                id="video-trailerId"
                name="trailerId"
                data-cy="trailerId"
                type="text"
              />
              <ValidatedField
                label={translate('entityDemoApp.video.description')}
              ...
              <ValidatedField
                ...
                name="userUpload"
                data-cy="userUpload"
                label={translate('entityDemoApp.video.userUpload')}
                type="select"
              >
                <option value="" key="0" />
                {userUploads
              ...
              <ValidatedField
                label={translate('entityDemoApp.video.genre')}
                id="video-genre"
                data-cy="genre"
                type="select"
                multiple
