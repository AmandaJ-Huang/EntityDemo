  ...
  return (
    <div>
      <h2 id="user-favorites-heading" data-cy="UserFavoritesHeading">
        <Translate contentKey="entityDemoApp.userFavorites.home.title">User Favorites</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="entityDemoApp.userFavorites.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="entityDemoApp.userFavorites.home.createLabel">Create new User Favorites</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userFavoritesList && userFavoritesList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="entityDemoApp.userFavorites.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="entityDemoApp.userFavorites.dateAdded">Date Added</Translate>
                </th>
                <th>
                  <Translate contentKey="entityDemoApp.userFavorites.appUser">App User</Translate>
                </th>
                <th>
                  <Translate contentKey="entityDemoApp.userFavorites.video">Video</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {userFavoritesList.map((userFavorites, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {userFavorites.appUser ? <Link to={`app-user/${userFavorites.appUser.id}`}>{userFavorites.appUser.id}</Link> : ''}
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="entityDemoApp.userFavorites.home.notFound">No User Favorites found</Translate>
            </div>
          )
        )}
      </div>
