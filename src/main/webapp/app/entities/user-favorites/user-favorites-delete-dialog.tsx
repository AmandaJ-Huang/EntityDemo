...
export const UserFavoritesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="entityDemoApp.userFavorites.delete.question">
        <Translate contentKey="entityDemoApp.userFavorites.delete.question" interpolate={{ id: userFavoritesEntity.id }}>
