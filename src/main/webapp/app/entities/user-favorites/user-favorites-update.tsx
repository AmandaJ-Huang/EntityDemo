  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="entityDemoApp.userFavorites.home.createOrEditLabel" data-cy="UserFavoritesCreateUpdateHeading">
            <Translate contentKey="entityDemoApp.userFavorites.home.createOrEditLabel">Create or edit a UserFavorites</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('entityDemoApp.userFavorites.dateAdded')}
              ...
              <ValidatedField
                ...
                name="appUser"
                data-cy="appUser"
                label={translate('entityDemoApp.userFavorites.appUser')}
                type="select"
              >
                <option value="" key="0" />
                {appUsers
              ...
              <ValidatedField
                label={translate('entityDemoApp.userFavorites.video')}
